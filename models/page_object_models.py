...
class PageAction(ABC):
    ...
    def wait_for_element(self, locator: str, state: Literal["attached", "detached", "visible", "hidden"] = "visible"):
    ...
    @abstractmethod
    def check_enabled_home_button(self, home_button: str) -> None:
        expect (self.page.locator(home_button)).to_be_enabled()

    @abstractmethod
    def check_enabled_all_movies_button(self, all_movies_button: str) -> None:
        expect (self.page.locator(all_movies_button)).to_be_enabled()
...
class BasePage(PageAction): #Базовая логика доспустимая для всех страниц на сайте
    def __init__(self, page: Page):
        ...
        self.home_button = "a.text-3xl[href='/']"
        self.all_movies_button = "a[href='/movies']"
    ...
    @allure.step("Проверка кликабельности кнопки перехода на главную страницу")
    def check_enabled_home_button(self):
        super().check_enabled_home_button(self.home_button)

    @allure.step("Проверка кликабельности кнопки перехода на страницу 'Все фильмы'")
    def check_enabled_all_movies_button(self):
        super().check_enabled_all_movies_button(self.all_movies_button)
...
class CinescopRegisterPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.register_button = "button.inline-flex[type='submit']"
...
class CinescopLoginPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.login_button = "button.inline-flex[type='submit']"
    ...
    def assert_allert_was_pop_up(self, text = "Вы вошли в аккаунт"):
        self.check_pop_up_element_with_text(text)
